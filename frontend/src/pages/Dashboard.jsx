import { CreditCard, ArrowUpRight, ArrowDownLeft, Wallet, LogOut, Shield } from 'lucide-react';
      ...
      <header className="dashboard-header">
        <div>
          ...
          <p className="text-muted">
            {isAdmin ? 'Panel de Administración Bancaria' : 'Bienvenido de nuevo a tu panel bancario.'}
          </p>
        </div>
            ...
            <div className="glass-card" style={{ background: 'linear-gradient(135deg, #3b82f6 0%, #1d4ed8 100%)', border: 'none' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
                <div>
                  ...
                  <p style={{ fontWeight: '600' }}>{user?.nombre}</p>
                </div>
